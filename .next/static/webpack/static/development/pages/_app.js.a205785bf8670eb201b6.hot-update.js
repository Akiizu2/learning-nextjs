...
function (_Component) {
  ...
  function SignIn() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onSignedIn", function () {
      ...
      Object(_firebase__WEBPACK_IMPORTED_MODULE_4__["signIn"])(email, password).catch(function (error) {
        alert(error.message);
      });
    });
...
//# sourceMappingURL=_app.js.a205785bf8670eb201b6.hot-update.js.map